...
export type BlogArticlePageContentModel = IApiContentModelBase & {
    contentType: 'blogArticlePage';
} & {
    properties?: BlogArticlePagePropertiesModel;
};

export type BlogArticlePageContentResponseModel = IApiContentResponseModelBase & {
    contentType: 'blogArticlePage';
} & BlogArticlePageContentModel;

export type BlogArticlePagePropertiesModel = {
    title?: string | null;
    content?: RichTextModel;
    components?: ApiBlockListModel;
};

export type BlogListingPageContentModel = IApiContentModelBase & {
    contentType: 'blogListingPage';
} & {
    properties?: BlogListingPagePropertiesModel;
};

export type BlogListingPageContentResponseModel = IApiContentResponseModelBase & {
    contentType: 'blogListingPage';
} & BlogListingPageContentModel;

export type BlogListingPagePropertiesModel = {
    [key: string]: never;
};
...
export type HomePagePropertiesModel = {
    [key: string]: never;
};
...
export type ImageComponentElementModel = IApiElementModelBase & {
    contentType: 'imageComponent';
} & {
    properties?: ImageComponentPropertiesModel;
};

export type ImageComponentPropertiesModel = {
...
export type QuoteComponentElementModel = IApiElementModelBase & {
    contentType: 'quoteComponent';
} & {
    properties?: QuoteComponentPropertiesModel;
};

export type QuoteComponentPropertiesModel = {
    quote?: string | null;
    author?: string | null;
};

export type RichTextComponentElementModel = IApiElementModelBase & {
    contentType: 'richTextComponent';
} & {
    properties?: RichTextComponentPropertiesModel;
};

export type RichTextComponentPropertiesModel = {
...
export type ClientOptions = {
    baseUrl: 'http://localhost:48006' | (string & {});
};